...
class ModelTraining:
    ...
    def load_and_split_data(self):
        """
        Load data from processed data and split into train test
        """
        try:
    ...
    def train_lgbm(self, X_train, y_train):
        """
        Train using LightGBM model for lightweight when compare to RandomForest and XGBoost
        """
        try:
            ...
            # get the hyperparamter from config file
    ...
    def run(self):
        """
        Run the complete model training pipeline and log to MLFLOW
        """
        try:
